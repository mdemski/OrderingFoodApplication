...
<%--                                        Okna obrotowa to popularna, rynkowa propozycja,--%>
...
<%--                                    <hr class="hr-light">--%>
<%--                                    <!-- Text -->--%>
<%--                                    <p class="card-text white-text mb-4">Okna wysokoosiwe stanowią odmianę okien obrotowych,--%>
...
<%--                                    <hr class="hr-light">--%>
<%--                                    <!-- Text -->--%>
<%--                                    <p class="card-text white-text mb-4">Okna nieotwieralne są propozycją dla osób, którym zależy wyłącznie na doświetleniu pomieszczeniu</p>--%>
<%--                                    <input type="submit"--%>
