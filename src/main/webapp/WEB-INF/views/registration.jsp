...
<div>
    <form:form class="text-center border border-light p-5" method="post" modelAttribute="data">
        ...
        <!-- Imię -->
        <form:input path="firstName" id="defaultLoginFormEmail" class="form-control mb-4" placeholder="Imię"/>

        <!-- Email -->
        <form:input path="email" id="defaultLoginFormEmail" class="form-control mb-4" placeholder="E-mail"/>

        <!-- Password -->
        <form:password path="password" id="defaultLoginFormPassword" class="form-control mb-4" placeholder="Hasło"/>
